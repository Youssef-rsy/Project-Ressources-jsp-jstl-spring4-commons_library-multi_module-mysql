...
public class DataSeed {
	...
	public void dataRessources(){
		...
		lst.add(new Ressources("rossamy", "youssef", new Date(), "collaborateur"));
		lst.add(new Ressources("jamoure", "youssef", new Date(), "collaborateur"));
		lst.add(new Ressources("hadi alaoui", "abdelhakim", new Date(), "collaborateur"));
		lst.add( new Ressources("chalih", "hajar", new Date(), "collaborateur"));
		lst.add(new Ressources("Hind", "sahih", new Date(), "Testeur"));
